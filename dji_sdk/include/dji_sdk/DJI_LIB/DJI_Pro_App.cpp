...
int DJI_Pro_Activate_API(activate_data_t *p_user_data, Command_Result_Notify user_notice_entrance) {

  // already tried, no matter what is the result
...
int DJI_Pro_Get_Broadcast_Data(sdk_std_msg_t *p_user_buf, uint16_t *msg_flags) {
  pthread_mutex_lock(&std_msg_lock);
